...
class FunpokedexControllerTest {
  ...
  private static void pokeapiAssertions(BlockingHttpClient client, String getParameter) {
  ...
  private static void funtranslationsapiAssertions(BlockingHttpClient client, String name) {
    HttpRequest<Object> request = HttpRequest.GET("/pokemon/translated/" + name);
